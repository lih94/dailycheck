...
for cmd_dir_modify_time_tmp in cmd_dir_modify_time:
    res = func.ssh('192.168.3.78', cmd_dir_modify_time_tmp)[0].split('\n')
    modify_time = []
    for res_tmp in res:
    ...
    print(cmd_dir_modify_time_tmp.strip().split(' ')[1] + ',' + time_string2)
